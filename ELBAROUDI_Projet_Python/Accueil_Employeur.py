...
sl=Salle()
#creating window
class Accueil_Emp(Tk):
    def __init__(self,root):
        self.root=root
        self.root.iconbitmap('images/libico.ico')
        self.root.title("Accueil Employeur")
        ...
        def Affiche_design():
            try:
                ...
                # label and input box
                self.label3 = Label(self.root, text='Employeur: Page accueil', fg='black', bg="white", font=('AlGERIAN', 30, 'bold'))
                ...
                self.brt = Button(self.root, text="Détail sur le film", bg="green", font=('Algerian', 10),
                                  command=affiche_detail).place(x=310, y=150)
                self.brt = Button(self.root, text="Ajouter un événement", bg="green", font=('Algerian', 10),command=Add_evenement).place(x=935, y=150)
                self.brt = Button(self.root, text="Modifier un événement", bg="green", font=('Algerian', 10),command=Update_evenement).place(x=610, y=150)
